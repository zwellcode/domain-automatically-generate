...
public class CodeBuilder {
    public static List builder(ParseVO vo){
        ...
        //qo
        list.add(templateParse(configuration, vo, TemplateCatalog.QUERYOBJECT));

        //repository
        list.add(templateParse(configuration, vo, TemplateCatalog.REPOSITORY));

        //service interface
        list.add(templateParse(configuration, vo, TemplateCatalog.ISERVICE));

        //service impl
        list.add(templateParse(configuration, vo, TemplateCatalog.SERVICEIMPL));
